/**
 * SQLite database access layer for the CNB Financial Regulation MCP server.
 *
 * Schema mirrors the CNB regulatory structure:
 *   - sourcebooks        — CNB regulatory sourcebook directories
 *   - provisions         — individual vyhlášky, úřední sdělení, dohledové benchmarky, and guidance provisions
 *   - enforcement_actions — CNB enforcement decisions and sanctions
 *
